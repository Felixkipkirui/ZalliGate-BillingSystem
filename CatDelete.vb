...
Public Class CatDelete
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Else
            Try
                Con.Open()
                Dim cmd As New MySqlCommand("DELETE FROM `category` WHERE `CatCode`=@foodcode", Con)
                cmd.Parameters.Clear()
                cmd.Parameters.AddWithValue("@foodcode", txtSearch.Text)
                Dim i As Integer
                i = cmd.ExecuteNonQuery
                If i > 0 Then
                    MsgBox("Category Delete Successfully !", vbInformation, "FAST FOOD")
                Else
                    MsgBox("Warning : Category Delete Failed !", vbCritical, "FAST FOOD")
                End If
    ...
    Private Sub CatDelete_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Load_fooddata()
