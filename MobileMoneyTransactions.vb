...
Public Class MobileMoneyTransactions
    ...
    Sub CashTotal()
        ...
        Dim query As String = "SELECT Sum(GrandTotal) FROM transactions WHERE PaymentMode = 'MOBILE MONEY' AND TransactionDate BETWEEN '" & StartFormatted & "' AND '" & EndFormatted & "' AND WorkShift = '" & cmbShift.Text & "'"
    ...
    Sub Loadgrid()
        ...
        Dim StartFormatted As String = StartSelectedDate.ToString("yyyy-MM-dd")
        Dim EndFormatted As String = EndSelectedDate.ToString("yyyy-MM-dd")
        Dim query As String = "SELECT TransactionNo, GrandTotal, Recieved, Balance, PaymentMode, RecievedBy, DateTime FROM transactions WHERE PaymentMode = 'MOBILE MONEY' AND TransactionDate BETWEEN '" & StartFormatted & "' AND '" & EndFormatted & "' AND WorkShift = '" & cmbShift.Text & "'"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        Printer.SubTitle = "Mobile Money Transaction Report For: " & StartDatePicker.Value & " - " & EndDatePicker.Value & vbCrLf & "Work Shift: " & cmbShift.Text
    ...
    Private Sub MobileMoneyTransactions_Load(sender As Object, e As EventArgs) Handles MyBase.Load
