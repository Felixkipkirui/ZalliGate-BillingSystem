...
Public Class AttendanceModule
    ...
    Sub LoadGrid()
        ...
        Dim query As String = "SELECT StaffID, StaffName, Username, Date, WorkShift, CheckInTime, CheckOutTime, TotalHours, Status FROM attendance WHERE Date BETWEEN '" & StartFormatted & "' AND '" & EndFormatted & "' AND WorkShift = 'SHIFT-1'"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        Printer.SubTitle = "Shift-1 Daily Attendance Report For: " & StartDatePicker.Value & " - " & EndDatePicker.Value
    ...
    Private Sub GunaAdvenceButton6_Click(sender As Object, e As EventArgs) Handles GunaAdvenceButton6.Click
        ...
        Dim frm As New Shift1AttendanceReport
        frm.Location = New Point((WorkingArea.Width - frm.Width) / 2, 0)
        TransaparentBG.ShowForm(frm)
        'frm.ShowDialog()
