...
Public Class Shift2AttendanceReport
    ...
    Sub LoadGrid()
        ...
        Dim query As String = "SELECT StaffID, StaffName, Username, Date, WorkShift, sum(TotalHours) as 'Work Hours' FROM attendance WHERE Date BETWEEN '" & StartFormatted & "' AND '" & EndFormatted & "' AND WorkShift = 'SHIFT-2' GROUP by StaffID"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        Printer.SubTitle = "Shift-2 Attendance Report For: " & StartDatePicker.Value & " - " & EndDatePicker.Value
